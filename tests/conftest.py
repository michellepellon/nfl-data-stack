...
@pytest.fixture
def sample_teams():
    """NFL teams loaded from seed data for tiebreaker testing"""
    seed_path = Path(__file__).parent.parent / "transform" / "data" / "nfl_teams_seed.csv"
    return pl.read_csv(seed_path).with_columns([
